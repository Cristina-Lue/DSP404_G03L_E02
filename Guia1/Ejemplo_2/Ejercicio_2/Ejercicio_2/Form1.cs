    ...
    public partial class Form1 : Form
    {
        ...
        private void btnAnalisis_Click(object sender, EventArgs e)
        {
            ...
            if (NomEmpre.Length == 0) {
                ...
                MessageBox.Show("Debes indicar el Nombre de la empresa", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            else
            {
                ...
                if (!(MontoInic > 0))
                {
                    MessageBox.Show("El Valor Monto no puede ser negativo", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    txtMonto.Focus();//metodo que indica que control txtEmpresa recibira cursor 
                    return;
                }
            }
            ...
            if (rdbInteres3.Checked == true)
            {
                ...
                {
                    MessageBox.Show("Aun no se ha indicado una tasa de interés", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    txtTasaInterEX.Focus();
                    return;
                }
            }
